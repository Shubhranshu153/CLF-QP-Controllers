function [t, x] = simulate_compassgait1(x0, tf, x_oneCycle, t_oneCycle, kp, kd, Q, epsilon, B)
...
%   matrix
% global mySpline kp kd Q epsilon B
% p = params();
p = params();
% p.gamma=2;
l = p.a + p.b;
...
while t_cur < tf
    ...
    [t_k,x_k,te,xe,ie] = ode45(@(t,x)ode_func(t,x,x_oneCycle,kp, kd, Q, epsilon, B), [t_cur, tf], x_cur, options);
